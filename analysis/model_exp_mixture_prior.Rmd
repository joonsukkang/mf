...
demo.update.B <- function(mat.X, Elsq, eta.grid, pi.grid, niter.updates = 10){
    ...
    Ew <- sqrt(Elsq)*sum(pi.grid*sqrt(eta.grid/2))+sum(pi.grid*eta.grid/2)
    Ew.inv <-  sum(pi.grid*sqrt(1/eta.grid))*sqrt(2/Elsq)
    }
...
```{r}
demo.fit <- function(mat.X, niter, r2, n.grid=10){
...
Currently, default number of grid points is set to **K=10** and each of them has probability 1/K.
...
par(mfrow=c(1,4))
obj.fit    <- demo.fit(mat.X, r2=1, niter=10, n.grid=6) 
plot(obj.fit$l, ylab='fitted', main='fitted l')
obj.fit    <- demo.fit(mat.X, r2=1, niter=10, n.grid=8) 
plot(obj.fit$l, ylab='fitted', main='fitted l')
obj.fit    <- demo.fit(mat.X, r2=1, niter=10, n.grid=10) 
plot(obj.fit$l, ylab='fitted', main='fitted l')
obj.fit    <- demo.fit(mat.X, r2=1, niter=10, n.grid=12) 
plot(obj.fit$l, ylab='fitted', main='fitted l')
obj.fit    <- demo.fit(mat.X, r2=1, niter=10, n.grid=14) 
plot(obj.fit$l, ylab='fitted', main='fitted l')
obj.fit    <- demo.fit(mat.X, r2=1, niter=10, n.grid=16) 
plot(obj.fit$l, ylab='fitted', main='fitted l')
obj.fit    <- demo.fit(mat.X, r2=1, niter=10, n.grid=18) 
plot(obj.fit$l, ylab='fitted', main='fitted l')
