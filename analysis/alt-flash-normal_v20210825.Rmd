...
```{r, eval=TRUE}
mb <- microbenchmark(
  flash.backfit   = flash.backfit(fit.init, verbose.lvl=0), # using original "flashier" (just for comparison with flash.backfit.e)
  flash.backfit.e = flash.backfit.e(fit.init, verbose.lvl=0), # using "flashier.backfit.e"
  flash.backfit.p = flash.backfit(fit.init, verbose.lvl=0, method='parallel'),
